...
public class SzlcxDialog extends Dialog {
	 ...
	 * @param style
	 */
	public SzlcxDialog(Shell parent, int style) {
		super(parent, style);
		setText("SWT Dialog");
	}
	...
	private void createContents() {
		...
		shell.setImage(ResourceManager.getPluginImage("Yyglxt", "icons/227153b35ecaed9869bebafe6a745e4a.jpg"));
		...
		button.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				ArrayList<String []> arr1=db.arrQuery("select *from fyt where id="+id);
				
				String str=arr1.get(0)[1];
				
				System.out.println("第"+str.substring(1, 2)+"大厅");
				
				ArrayList<String []> arr=db.arrQuery("select *from filmticket where time like '%"+y+"-"+m+"%' and address like '%"+"第"+str.substring(1, 2)+"大厅"+"%'");
				
				
				
				ArrayList<String []> arr2=db.arrQuery("select *from upfilm where startTime like '%"+y+"-"+m +"%' and fyt like '%"+str.substring(1, 2)+"%'");
		...
		button.setBounds(326, 163, 79, 27);
		button.setText("\u67E5\u8BE2");
